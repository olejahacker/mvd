...
# эта функция для замены той, которой уже нет в scipy
from skimage.transform import resize
from skimage import io
import skvideo
# укажите здесь свой путь к ffmpeg (например, ffmpeg-4.4-essentials_build\\bin)
...
class Video(object):
    ...
    def get_frames_mouth(self, detector, predictor, frames):
        ...
        for frame in frames:
            ...
            # здесь заменили на новую функцию
...
def preprocess(from_idx, to_idx, _params):
    ...
    # здесь нужно указать путь на shape_predictor_68_face_landmarks.dat
    face_predictor_path = ''
    succ = set()
    fail = set()
